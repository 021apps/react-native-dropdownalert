						...
						if (this.props.updateStatusBar) {
							if (IS_ANDROID) {
								...
								StatusBar.setBarStyle(
									this.props.inactiveStatusBarStyle,
									true
								);
							}
						}
		...
		if (isOpen) {
			...
			return (
				...
				>
					<TouchableOpacity
						activeOpacity={
							!this.props.tapToCloseEnabled || showCancel
								? 1
								: 0.95
						}
						...
						<View style={style}>
							<View
								style={StyleSheet.flatten(
									this.props.defaultTextContainer
								)}
							>
								<Label
									style={StyleSheet.flatten(
							...
							{showCancel && (
								<TouchableOpacity
									style={{
										alignSelf: this.props
											.cancelBtnImageStyle.alignSelf,
										width: this.props.cancelBtnImageStyle
											.width,
										height: this.props.cancelBtnImageStyle
											.height
									}}
